...
export async function generateMetadata({ params }: Props) {
  ...
  return { title, description: language === 'fi' ? 'Opi suomea arkeen ja työhön. Oppitunteja ja harjoituksia omalla tasollasi.' : 'Öva svenska för vardag och arbete. Välj din nivå och öva olika färdigheter.', alternates: { canonical: `/course/${language}/levels` }, openGraph: { title, locale: language === 'fi' ? 'fi_FI' : 'sv_FI', url: `/course/${language}/levels` }, twitter: { card: 'summary' as const, title } }
}
